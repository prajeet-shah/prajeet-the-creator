    ...
    faqs: [
      {
        ...
        answer:
          "COMPEX is a scholarship provided by the Embassy of India, Kathmandu for Nepalese students to study undergraduate courses in India through a competitive entrance exam.",
      },
      {
        question: "Is COMPEX fully funded?",
        answer:
          "Yes, it generally covers tuition fees, hostel accommodation, and provides a monthly stipend, but final benefits depend on the allocated institution.",
      },
      {
        question: "Is there any entrance exam?",
        answer:
          "Yes, selection is based on a Computer-Based Test (CBT) conducted by the Embassy of India.",
      },
      {
        question: "Can I apply for multiple courses?",
        answer:
          "Yes, you can apply for a maximum of two courses only.",
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "It provides NPR 24,000 per year for 2 years (Class 11 and 12) to support students studying in Nepal."
      },
      {
        question: "Can I use this scholarship to study in India?",
        answer:
          "No, this scholarship is only for Nepalese students studying in Nepal."
      },
      {
        question: "Will the scholarship continue in Class 12?",
        answer:
          "Yes, but only if the student passes Class 11 and submits required documents like marksheet and promotion certificate."
      }
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "It provides financial assistance per year depending on the course: NPR 48,000 for professional courses (MBBS, BDS, Engineering, etc.) and NPR 36,000 for other courses."
      },
      {
        question: "Can I use this scholarship to study in India?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes, but only if the student passes each academic year and submits required documents like marksheets and promotion certificates."
      }
    ],
